  ...
  ({ className, label, value, ...props }, ref) => {
    ...
    return (
      <>
        ...
        <div 
          ref={containerRef}
          className={cn("relative glow-input rounded-lg", className)}
          style={glowStyles}
        >
          <motion.div
            className="absolute top-1/2 left-3 -translate-y-1/2 pointer-events-none text-foreground"
          ...
          <input
            ...
            {...props}
            className="outline-none py-3 px-3 w-full text-base font-medium text-foreground bg-transparent placeholder-transparent focus-visible:placeholder:text-muted-foreground rounded-lg cursor-pointer"
          />
        </div>
      </>
    );
