...
const Repertoire = () => {
  ...
  const songs = [
    ...
    { artist: "Böhse Onkelz", title: "Leere Worte", genre: ["Hard Rock", "Deutschrock"] },
    { artist: "The White Stripes", title: "Seven Nation Army", genre: ["Garage Rock", "Alternative", "Indie", "Blues Rock", "Rock"] },
    { artist: "Volbeat", title: "Thanks", genre: ["Metal", "Heavy Metal", "Hard Rock", "Rockabilly"] },
    { artist: "Peter Schilling/Die Ärzte/The McCoys", title: "Medley: Major Tom/Westerland/Hang on Sloopy", genre: ["Mix"] },
    { artist: "Rammstein", title: "Deutschland", genre: ["Industrial Metal", "Metal"] },
    ...
    { artist: "Joan Jett", title: "I Love Rock'N Roll", genre: ["Rock", "Hard Rock"] },
    ...
    { artist: "Billy Talent", title: "Fallen Leaves", genre: ["Alternative", "Rock"] },
    { artist: "Lenny Kravitz", title: "Fly Away", genre: ["Funk", "Alternative"] },
    { artist: "Sportfreunde Stiller", title: "Ein Kompliment", genre: ["Indie", "Rock", "Alternative"] },
    { artist: "Böhse Onkelz", title: "Stunde des Siegers", genre: ["Hard Rock", "Deutschrock"] },
    { artist: "Nirvana", title: "Rape Me", genre: ["Grunge"] },
    { artist: "Nickelback", title: "How You Remind Me", genre: ["Post-Grunge", "Hard Rock"] },
    { artist: "Sum 41", title: "In Too Deep", genre: ["Punk Rock", "Alternative"] },
    { artist: "Ramones", title: "Blitzkrieg Bop", genre: ["Punk Rock"] },
    { artist: "Böhse Onkelz", title: "Kirche", genre: ["Hard Rock", "Deutschrock"] },
    { artist: "The Hives", title: "Tick Tick Boom", genre: ["Garage Rock", "Alternative", "Indie"] },
    { artist: "Die Ärzte", title: "Himmelblau", genre: ["Punk Rock"] },
    { artist: "Green Day", title: "Brain Stew", genre: ["Punk Rock", "Alternative"] },
    { artist: "Volbeat", title: "Fallen", genre: ["Metal", "Rockabilly"] },
    { artist: "The Offspring", title: "Pretty Fly", genre: ["Punk Rock", "Skate Punk", "Alternative"] },
    { artist: "Puddle Of Mudd", title: "She Hates Me", genre: ["Post-Grunge", "Alternative"] },
    { artist: "Manowar", title: "Warriors of the World", genre: ["Heavy Metal"] },
    { artist: "Metallica", title: "For Whom The Bell Tolls", genre: ["Metal", "Heavy Metal"] },
    { artist: "Böhse Onkelz", title: "Wir ham noch lange nicht genug", genre: ["Hard Rock", "Deutschrock"] },
    { artist: "Böhse Onkelz", title: "Mexico", genre: ["Hard Rock", "Deutschrock"] },
    { artist: "Die Ärzte", title: "Deine Schuld", genre: ["Punk Rock"] },
    { artist: "Farin Urlaub", title: "OK", genre: ["Rock", "Punk Rock"] },
    { artist: "Green Day", title: "When I Come Around", genre: ["Punk Rock", "Alternative"] },
    { artist: "Böhse Onkelz", title: "Ich bin in Dir", genre: ["Hard Rock", "Deutschrock"] },
    { artist: "Rammstein", title: "Rammstein", genre: ["Industrial Metal", "Metal"] },
    { artist: "The White Stripes", title: "The Hardest Button to Button", genre: ["Garage Rock", "Alternative", "Indie"] },
    { artist: "Blur", title: "Song 2", genre: ["Alternative", "Rock", "Indie"] },
    { artist: "Nirvana", title: "Come As You Are", genre: ["Grunge", "Alternative"] },
    { artist: "The Subways", title: "Rock & Roll Queen", genre: ["Indie", "Rock", "Alternative"] },
    { artist: "Die Ärzte", title: "Hurra", genre: ["Punk Rock"] },
    { artist: "Judas Priest", title: "Living After Midnight", genre: ["Heavy Metal", "Metal"] },
    { artist: "Sleipnir", title: "Alkoholiker", genre: ["Rock"] },
    { artist: "AC/DC", title: "Highway to Hell", genre: ["Rock", "Hard Rock"] },
    { artist: "Metallica", title: "Die, Die My Darling", genre: ["Metal", "Heavy Metal"] },
    { artist: "Böhse Onkelz", title: "Bin ich nur glücklich wenn es schmerzt", genre: ["Hard Rock", "Deutschrock"] },
    { artist: "Green Day", title: "Holiday", genre: ["Punk Rock", "Alternative"] },
    { artist: "Die Ärzte", title: "Schrei nach Liebe", genre: ["Punk Rock"] },
    { artist: "The Hives", title: "Hate To Say I Told You So", genre: ["Garage Rock", "Alternative"] },
    { artist: "Danzig", title: "Mother", genre: ["Heavy Metal", "Hard Rock"] },
    { artist: "Lynyrd Skynyrd", title: "Simple Man", genre: ["Southern Rock", "Hard Rock"] },
    { artist: "Nirvana", title: "Smells Like Teen Spirit", genre: ["Grunge"] },
    { artist: "Böhse Onkelz", title: "Nur die besten sterben jung", genre: ["Hard Rock", "Deutschrock"] },
    { artist: "Böhse Onkelz", title: "Auf gute Freunde", genre: ["Hard Rock", "Deutschrock"] },
    { artist: "Wolfmother", title: "Joker And The Thief", genre: ["Rock", "Hard Rock"] },
    { artist: "Green Day", title: "American Idiot", genre: ["Punk Rock", "Alternative"] },
    { artist: "Böhse Onkelz", title: "Für immer", genre: ["Hard Rock", "Deutschrock"] },
    { artist: "Böhse Onkelz", title: "Die Firma", genre: ["Hard Rock", "Deutschrock"] },
    { artist: "Böhse Onkelz", title: "Terpentin", genre: ["Hard Rock", "Deutschrock"] },
    { artist: "Red Hot Chili Peppers", title: "Californication", genre: ["Alternative", "Funk"] },
    { artist: "Böhse Onkelz", title: "Du kannst alles haben", genre: ["Hard Rock", "Deutschrock"] }
  ];
