	...
	theme: {
		...
		extend: {
			colors: {
				...
				rock: {
					blue: 'hsl(var(--rock-blue))',
					'blue-glow': 'hsl(var(--rock-blue-glow))',
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': { boxShadow: '0 0 20px hsl(var(--rock-blue-glow) / 0.3)' },
					'50%': { boxShadow: '0 0 40px hsl(var(--rock-blue-glow) / 0.6)' }
				},
				'float': {
